...
class ChatService {
  ...
  async sendMessage(conversationId: string, senderId: string, receiverId: string, text: string, productId?: string): Promise<Message> {
  ...
  async createConversation(user1Id: string, user2Id: string, initialMessage?: string, productId?: string): Promise<Conversation> {
